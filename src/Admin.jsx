...
const DEMO_PLANS=[{id:"basic",name:"Basic",price:5000,max_properties:1,features:["1 établissement","3 photos","WhatsApp"],color:"#64748b"},{id:"premium",name:"Premium",price:10000,max_properties:3,features:["3 établissements","Sponsorisé","Prioritaire"],color:"#FF6B00"},{id:"enterprise",name:"Enterprise",price:15000,max_properties:999,features:["Illimité","Page dédiée","Support 24/7"],color:"#7C3AED"}];
